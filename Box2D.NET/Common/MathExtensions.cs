...
public static class MathExtensions
{
    ...
    public static bool ToleranceEquals(this float a, float b, float tolerance = 1e-6f) => Math.Abs(a - b) <= tolerance;
    ...
    /// <returns>True if values are approximately equal, otherwise false.</returns>
    public static bool ToleranceEquals(this double a, double b, double tolerance = 1e-9) => Math.Abs(a - b) <= tolerance;
}