...
public struct Vector2(float x, float y) : IEquatable<Vector2>
{
    ...
    /// Index 0 corresponds to X, and index 1 corresponds to Y.
    /// </summary>
    /// <param name="index">The index of the component to access (0 or 1).</param>
    ...
    /// <inheritdoc />
    public readonly bool Equals(Vector2 other) => X.ToleranceEquals(other.X) && Y.ToleranceEquals(other.Y);
